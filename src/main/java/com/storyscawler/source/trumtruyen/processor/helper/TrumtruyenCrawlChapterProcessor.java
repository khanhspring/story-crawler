...
public class TrumtruyenCrawlChapterProcessor {
    ...
    private static PageResult<Map<String, String>> extractPageContent(JsoupActionExecutor executor, String url) {
        ...
        var btnNextExtractor = ElementExtractor
                .element(ElementLocator.cssSelector("#chapter-nav-top .next-chap"))
                .attr("href", "href")
        ...
        var nextChapterSlug = TrumtruyenUtils.extractChapterSlug(btnNext.get("href"));
